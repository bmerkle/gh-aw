...
See the [Security Guide](/gh-aw/introduction/architecture/#authorization-and-token-management) for complete documentation.
...
See [CLI Commands](/gh-aw/setup/cli/#compile) and [Security Guide](/gh-aw/introduction/architecture/#strict-mode-validation) for details.
